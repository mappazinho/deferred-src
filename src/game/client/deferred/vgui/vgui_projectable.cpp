...
{
	KeyValues *pFg = pKV->FindKey( "fgcolor", false );
	KeyValues *pBg = pKV->FindKey( "bgcolor", false );
	SetFgColor( pFg ? pFg->GetColor() : Color( 255,255,255,255 ) );
	SetBgColor( pBg ? pBg->GetColor() : Color( 0,0,0,0 ) );
}
