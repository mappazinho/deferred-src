...
public:
	...
	virtual bool				IsMaterialLoaded( char const* pMaterialName ) { return m_pBaseMaterialsPassThru->IsMaterialLoaded( pMaterialName ); }
	...
	virtual void				SetAsyncTextureLoadCache( void* hFileCache ) { m_pBaseMaterialsPassThru->SetAsyncTextureLoadCache( hFileCache ); }
	...
	virtual IMaterial *			FindMaterialEx( char const* pMaterialName, const char *pTextureGroupName, int nContext, bool complain = true, const char *pComplainPrefix = NULL ) { return m_pBaseMaterialsPassThru->FindMaterialEx( pMaterialName, pTextureGroupName, nContext, complain, pComplainPrefix ); }
