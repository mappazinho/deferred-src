...
static ConVar r_flashlightvolumetrics( "r_flashlightvolumetrics", "0", FCVAR_ARCHIVE,
	"Enable volumetric scattering for the player flashlight." );

CFlashlightEffectDeferred::CFlashlightEffectDeferred( int nEntIndex )
