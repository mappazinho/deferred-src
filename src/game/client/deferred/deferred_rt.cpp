...
{
	if ( !bInitial )
		return; // SDK 2013 automatically resizes RT_SIZE_* render targets on mode changes.
...
const ImageFormat fmt_gbuffer0 =
	...
	AssertMsg( fmt_depth != IMAGE_FORMAT_UNKNOWN, "Shadow depth textures are unsupported by this adapter" );
