...
for %%P in (mathlib\mathlib tier1\tier1 vgui2\vgui_controls\vgui_controls materialsystem\swarmshaders\game_shader_deferred_episodic game\gameui2\gameui2 game\client\client_episodic game\server\server_episodic) do (
    echo ===== BUILDING %%P =====
